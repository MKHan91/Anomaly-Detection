from autoencoder_dataloader_server import *
from autoencoder_model import *
from generate_model_server import *
...
parser.add_argument('--model_name',         type=str,   help='model_name',              default='BTT_CVAE_v2')
parser.add_argument('--model_type',         type=str,   help='type of model',           default='CVAE_v2')
parser.add_argument('--train_data_path',    type=str,   help='path to the data',
                    default='/home/onepredict/Myungkyu/LG_CNS/LG_CNS_data/By_datasetMK')
parser.add_argument('--test_data_path',     type=str,   help='path to the data',
                    default='/home/onepredict/Myungkyu/BVMS_turbine/01_About_data/02_Test_Data/Raw_state')
...
parser.add_argument('--log_directory',      type=str,   help='path to a specific checkpoint to load',
                    default='/home/onepredict/Myungkyu/BVMS_turbine/02_About_result/01_Training_Result/01_Log_Dir')
parser.add_argument('--checkpoint_path',    type=str,   help='path to a specific checkpoint to load', default='')
parser.add_argument('--output_directory',   type=str,   help='output directory for test',
                    default='/home/onepredict/Myungkyu/BVMS_turbine/02_About_result/01_Training_Result/03_Output_image')
